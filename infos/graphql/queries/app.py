...
class App(BalderQuery):
    class Arguments:
        ...
        client_id = graphene.String(description="The client id of one associated oauth2 application")
    ...
    def resolve(root, info, *args, name=None, identifier=None, version=None, id=None, client_id=None):
        ...
        if client_id:
            return models.FaktApplication.objects.get(client_id=client_id).app
